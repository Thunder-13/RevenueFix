...
interface NetworkBillingDataMetrics {
  data: {
...
const Data = () => {
  const [data, setData] = useState<NetworkBillingDataMetrics | null>(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await apiService.getNetworkVsBillingData();
